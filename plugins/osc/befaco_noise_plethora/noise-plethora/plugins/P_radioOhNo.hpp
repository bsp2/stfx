...
public:
	...
	void init() override {
		waveformMod1.begin(0.8f, 500, WAVEFORM_PULSE);
		waveformMod2.begin(0.8f, 1500, WAVEFORM_PULSE);
		waveformMod3.begin(0.8f, 600, WAVEFORM_PULSE);
		waveformMod4.begin(0.8f, 1600, WAVEFORM_PULSE);
	}
